    ...
    <body>
          ...
          <section class="singlepost">
            <div class="container singlepost_container">
                <h2>Great Migration Of Wildebeests</h2>
                <div class="post_author">
                    <div  class="post_author-avatar">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUvnTO-vvxvwqdb3bIyzrrYgjYYzE6WfVkJQ&usqp=CAU">
                    </div>
                ...
                <p>
                Coutersy Of Kenyan Tourism
                </p>
                <p>
                    Spectacular scenes when you visit the Nothern part of Kenya takes you to your origin; the cradle of mankind, Lake Turkana and a pure desert landscape, while the south takes you to the Masaai plains which comprises of some of the world's most diverse wildlife parks.Experience the 8th new wonder of the world by witnessing the spectacular annual wildebeest migration.
                </p>
                <p>
                    lorem ipsum
                </p>
